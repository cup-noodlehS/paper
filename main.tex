...
To mitigate detector inconsistency on vehicle classes that are common in dense mixed traffic (e.g., motorcycles), the system will incorporate track-level label stabilization (fuzzy-enhanced association and class stabilization) rather than relying on per-frame class labels alone \parencite{Santiago2023}.
