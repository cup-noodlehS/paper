...
Automated traffic violation detection for CCTV-based enforcement requires stable detections, temporally consistent tracking, and interpretable rule reasoning under occlusion and distribution shift \parencite{Olugbade2022,Wen2020}. Accordingly, this study is guided by the following research questions:
